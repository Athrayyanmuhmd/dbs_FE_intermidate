...
class DetailPage {
  ...
  cleanup() {
    ...
    if (saveButton)
      saveButton.removeEventListener("click", this._handleSaveClick);
    if (cancelButton)
      cancelButton.removeEventListener("click", this._handleCancelClick);
    if (removeButton)
      removeButton.removeEventListener("click", this._handleRemoveClick);
    if (retryButton && this._retryHandler) {
